...
// #Option for details.
//
// https://godoc.org/github.com/mokhae/opcua#Option
...
func (c *Client) Connect(ctx context.Context) error {
	...
	// todo(fs): see the discussion in https://github.com/mokhae/opcua/pull/512
			...
			for action != none {
				...
				default:
					...
					case createSecureChannel:
						...
						// todo(fs): down.
						//
						// https://github.com/mokhae/opcua/pull/470
						c.conn.Close()
...
func (c *Client) Close(ctx context.Context) error {
	...
	// https://github.com/mokhae/opcua/pull/462
	//
...
func (c *Client) ActivateSession(ctx context.Context, s *Session) error {
	...
	return c.SecureChannel().SendRequest(ctx, req, s.resp.AuthenticationToken, func(v ua.Response) error {
		...
		//
		// https://github.com/mokhae/opcua/issues/474
		//
...
func (c *Client) Send(ctx context.Context, req ua.Request, h uasc.ResponseHandler) error {
