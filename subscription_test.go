...
// Running tool: /Users/frank/sdk/go1.17.1/bin/go test -benchmem -run=^$ -bench ^BenchmarkUnmonitorItems$ github.com/mokhae/opcua

// goos: darwin
// goarch: arm64
// pkg: github.com/mokhae/opcua
...
// PASS
// ok  	github.com/mokhae/opcua	116.192s
